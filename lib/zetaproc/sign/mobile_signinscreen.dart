...
class MobileSigninScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('MobileSigninScreen'),
      ),
      body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              GoogleWidgetButtonContainer(
                onTap: () {
                  ref.read(messageProvider).showMessage('Sign in with Google is not ready');
                },
                hasIcon: true,
              ...
              GoogleWidgetButtonContainer(
                onTap: () {
                  ref.read(messageProvider).showMessage('Sign in with Apple is not ready');
                },
                hasIcon: true,
                icon: const Icon(
